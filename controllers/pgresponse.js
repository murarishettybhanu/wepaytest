                    ...
                    if (success) {
                        ...
                        if (status == 'success') {
                            if (req.session.mode == 'topup') {
                                ...
                                axios.get(`https://joloapi.com/api/v1/recharge.php?userid=wepays&key=199806557641007&operator=${req.session.operator}&service=${req.body.phone}&amount=${Math.round(amount)}&orderid=${req.body.tnxid}`)
